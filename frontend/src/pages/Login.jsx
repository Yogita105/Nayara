  ...
  return (
    <div className="max-w-md mx-auto px-6 py-16" data-testid="login-page">
      <div className="rounded-3xl border border-[var(--nayara-border)] bg-white p-10 text-center">
        ...
        <p className="text-[#5C7671] mt-2">Sign in to save your wishlist, track orders and check out faster.</p>
        ...
        <div className="mt-6 text-xs text-[#5C7671] flex items-center justify-center gap-3">
