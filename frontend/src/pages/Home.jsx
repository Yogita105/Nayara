  ...
  return (
    <div data-testid="home-page">
      ...
      <section className="relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-white/80 via-white/70 to-[#F8F9FA]" />
        <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-28 lg:pt-24 lg:pb-40">
          ...
          <p className="mt-6 max-w-xl text-[#5C7671] text-base md:text-lg leading-relaxed">
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl">
            {[
              ...
              <div key={i} className="flex items-center gap-2 text-sm text-[#1A2E2A]">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] font-bold text-[#5C7671] mb-3">Bestsellers</p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-7 rounded-3xl overflow-hidden relative aspect-[16/10]">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-[#1A2E2A]/60 to-transparent" />
          ...
          <div className="col-span-12 md:col-span-5 grid grid-cols-1 gap-6">
            <div className="rounded-3xl bg-white border border-[var(--nayara-border)] p-8">
              <p className="text-xs uppercase tracking-[0.2em] font-bold text-[#5C7671] mb-3">Factory Direct Pricing</p>
              <h3 className="font-heading text-2xl font-medium">Up to 30% lower than shelf.</h3>
              <p className="mt-3 text-sm text-[#5C7671] leading-relaxed">By skipping distributors, we pass the savings back to you without ever compromising on quality.</p>
            </div>
      ...
      {/* CATEGORIES */}
      <section className="max-w-7xl mx-auto px-6 py-20">
        <p className="text-xs uppercase tracking-[0.2em] font-bold text-[#5C7671] mb-3">Explore</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <Link key={c.key} to={`/shop?category=${c.key}`} className="group relative rounded-3xl overflow-hidden aspect-[4/5]" data-testid={`category-${c.key}`}>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1A2E2A] via-[#1A2E2A]/30 to-transparent" />
