...
from .models import Product, advertised_price
...
SEED_PRODUCTS: List[Dict[str, Any]] = [
    {
        ...
        "featured": True,
        "option_name": "Size",
        "variants": [{"label": "Standard", "price": 45.0, "mrp": 60.0, "stock": 250}],
    },
    {
        "name": "Nayara Washing Powder Detergent",
        "slug": "washing-powder",
        "category": "laundry",
        ...
        "featured": True,
        "option_name": "Weight",
        "variants": [{"label": "1kg", "price": 180.0, "mrp": 240.0, "stock": 180}],
    },
    {
        "name": "Nayara Liquid Detergent",
        ...
        "featured": True,
        "option_name": "Volume",
        "variants": [{"label": "1L", "price": 249.0, "mrp": 329.0, "stock": 150}],
    },
    {
        ...
        "featured": False,
        "option_name": "Size",
        "variants": [{"label": "Standard", "price": 35.0, "mrp": 50.0, "stock": 300}],
    },
    {
        "name": "Nayara Handwash Liquid",
        ...
        "featured": True,
        "option_name": "Volume",
        "variants": [{"label": "250ml", "price": 99.0, "mrp": 145.0, "stock": 220}],
    },
    {
        ...
        "featured": True,
        "option_name": "Size",
        "variants": [{"label": "Standard", "price": 55.0, "mrp": 75.0, "stock": 400}],
    },
    {
        "name": "Nayara Toilet Cleaner",
        "slug": "toilet-cleaner",
        "category": "home-care",
        ...
        "featured": False,
        "option_name": "Volume",
        "variants": [{"label": "500ml", "price": 120.0, "mrp": 165.0, "stock": 160}],
    },
]
